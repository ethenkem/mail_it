...
import EmailVerification from "../pages/EmailVerifcation.jsx"
      ...
      <Box className="flex bg-white py-2 px-5  rounded-lg justify-center items-center">
        ...
        <div className="p-8">
          <div className="flex justify-between items-center">
            <p className="text-gray-600 mb-5 text-xl">Welcome back</p>
          </div>
          <h2 className="text-xl font-bold text-gray-700 mb-2">Please enter your details to login</h2>
