...
const HeroSection = ({ showLoginModal, setShowLoginModal }) => {
  return (
    <div className="relative px-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8  bg-gradient-to-b from-indigo-50  to-white pt-20 pb-16 rounded-4xl text-center lg:pt-32">
        ...
        <div className="mt-10 max-w-sm mx-auto sm:max-w-none sm:flex sm:justify-center">
          <div className="space-y-4 sm:space-y-0 sm:mx-auto sm:inline-grid sm:grid-cols-2 sm:gap-5">
            <button onClick={() => setShowLoginModal(!showLoginModal)} className="flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 md:py-4 md:text-lg md:px-10">
              Start Free Trial
            </button>
